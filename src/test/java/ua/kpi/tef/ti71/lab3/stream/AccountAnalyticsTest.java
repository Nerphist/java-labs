...
import ua.kpi.tef.ti71.lab3.stream.Account;
...
import ua.kpi.tef.ti71.lab3.stream.AccountAnalytics;
import ua.kpi.tef.ti71.lab3.stream.Sex;
...
public class AccountAnalyticsTest {
    ...
    public void testCollectBalancesByIdForAccountsCreatedOn() {
        ...
        Map<Long, BigDecimal> emailToBalanceMap = analytics.collectBalancesByIdForAccountsCreatedOn(account.getCreationDate().getYear());

        assertEquals(Map.of(account.getId(), account.getBalance()), emailToBalanceMap);
    }
